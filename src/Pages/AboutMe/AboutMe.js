...
const AboutMe = () => {
  return (
    <div
      id="about"
      className="mt-52 text-white lg:mx-40 bg-black bg-opacity-50 rounded-2xl shadow-2xl p-5"
    >
      <div className="mx-auto grid  grid-cols-1 lg:grid-cols-2 place-items-center">
        <div className="mt-28">
          <div>
            <h1 className="text-5xl font-bold flex gap-2">
              About Me{" "}
              <hr className="my-4   w-48 h-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 ...  rounded border-0 md:my-10 dark:bg-gray-700"></hr>{" "}
            </h1>
            <div></div>
          </div>
          <Fade>
        ...
        <div className="mt-48">
          ...
          <p className="text-slate-300 mt-2">
            I'm Saidur Rahman, a web developer with experience in MERN stack
            technologies. This includes MongoDB, Express, React , Node.js,
            Firebase & Sanity. I have 1 years of experience in web Design & 6
            month of experience in MERN Stack. I have a passion for learning new
            technologies and optimizing my skills. One of my special ability is
            i can easily improve myself through the use of modern technology.
          </p>
